...
River's prompt `claude-code-prompt-2026-09-07-suspension-reference.md` applied, then the follow-up `claude-code-prompt-2026-09-07-suspension-followup.md` (2026-09-08). The report file both name, `suspension-reference-2026-09-07.md` (the follow-up says `docs/suspension-reference-2026-09-07.md`), was NOT in Downloads, the repo or the remote on either pass; everything the prompts spell out themselves was built, and everything that lives only in the report file is listed as owed at the end. Same format as `docs/open-questions-resolution-2026-09-07.md`: answer, source, what changed, what remains for River. No figure tagged inferred is surfaced as stock or as a verified range; "not found" is null.
...
- **Not written, logged (follow-up section 2):** Beta RR Race Edition 2020: the catalog's KYB stands, the report's Sachs row (16 / 14, shock 15 / 12 / 15) is a source conflict. Beta RR-S 2020: no catalog row. Sherco SEF-R Sachs 2019 to 2021 figures conflict with the catalog's KYB-from-2019 Factory line; not written, and no SEF-R figure remains on any row. Suzuki RM-Z250: the catalog's KYB shock stands, the report's BFRC sharing is a source conflict. The tuner rows the follow-up lists for migration `20260907220000` (Honda CRF450R 2017 to 2020 and 2021 to 2024, CRF250R 2022 to 2025, RM-Z450 2018+ with fork comp 6 out and the shock in turns, YZ250F 2014+, KX450 2016 to 2018, KX250F 2006 to 2019 at 15 / 15, Stark Varg MX 2023+) need the report's source strings and its fork families, so they wait for the file; `docs/catalog-gaps.md` carries the list.
...
- **River:** the report file, so the tuner rows, the not-found list and the 4a tally can land.
...
- **4a Rutted hardpack:** research supports the current rule (fork rebound +1 out). No change; the comment names the support. The source tally with counts is in the report file and is still owed (follow-up section 1).
...
1. The report file `suspension-reference-2026-09-07.md` was not in Downloads, the repo or the remote on either pass: the tuner 1a rows for migration `20260907220000`, the not-found list and the 4a tally are owed from it (`docs/catalog-gaps.md`).
...
4. The BFRC baseline anchor (a quarter turn per click) waits for the RM-Z450 stock turns in the report file.
