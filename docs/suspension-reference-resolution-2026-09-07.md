...
- **River:** nothing open here after the 2026-09-08 calls (KX250 to the gap sweep, WP shock maxima written as tuner, RM-Z250 and Beta stay logged).
...
- **River's call (2026-09-08):** the WP linkage and PDS shock maxima the report offers are written as tuner by migration `20260907240000` (linkage LSC 18 as the midpoint of about 17 to 20, HSC 2 turns, rebound 20; PDS HSC 1.75 turns; Slavens and Vital MX, the range in the note); `click_range_verified` stays false, so a factory confirmation is a flag flip. A manual page or a physical count per family promotes a row to factory and shows its bars.
...
4. The BFRC baseline anchors on the RM-Z450's stock turns now; the quarter-turn-per-click placeholder remains only for a turns shock without stock turns. The WP linkage and PDS shock maxima are written as tuner (River's call, migration `20260907240000`).
