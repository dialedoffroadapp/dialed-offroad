...
/* ---------------------------------------------------------------------- */
/* TEST SNAPSHOT — frozen copy of the committed v1 engine (git HEAD).     */
/* Extracted mechanically for the v2 regression guard. Do not edit.       */
/* ---------------------------------------------------------------------- */
export { buildTuneTwo as buildTuneTwoV1, safeShape as safeShapeV1 };
export type { Tune2Feedback as Tune2FeedbackV1, ZeroResult as ZeroResultV1 };
