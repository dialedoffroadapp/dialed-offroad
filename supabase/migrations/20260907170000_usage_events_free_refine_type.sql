-- free_refine_used (2026-09-07): logged when a free refinement completes
-- (Done on a quick refine settles the version) with bike_id, setup_id and
-- the allowance remaining. STAGED, NOT PUSHED.
--
-- Carries the FULL list: the 20260904130000 set (94) + 1 = 95. Never add
-- another re-add without carrying all 95.
