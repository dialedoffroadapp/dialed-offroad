-- air_fork_override_set (2026-09-08): the rider answered air or coil on a
-- region-ambiguous 2016 row, meta {bike_id, air_fork, source: banner | quiz}.
-- STAGED, NOT PUSHED.
--
-- Carries the FULL list: the 20260907200000 set (98) + 1 = 99. Never add
-- another re-add without carrying all 99.
